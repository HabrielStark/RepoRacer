...
export async function mineTasks(repoRoot, config, options = {}) {
    ...
    for (const [index, candidate] of selected.entries()) {
        ...
        const hiddenTestFiles = config.hiddenTests.enabled
            ...
            : [];
        const hiddenTestPatchPath = hiddenTestFiles.length > 0 ? repoRacerPath(repoRoot, "patches", id, "hidden-tests.patch") : null;
...
function isHiddenTestFile(filePath, patterns) {
...
export async function saveTasks(repoRoot, tasks, runId) {
...
//# sourceMappingURL=task-miner.js.map