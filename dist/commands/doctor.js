...
import { createGitWorktree, dirtyEntries, getHeadSha, getRepoRoot, gitLfsDiagnostics, isGitRepo, isShallowRepository, listConfiguredSubmodules, removeGitWorktree } from "../core/git.js";
...
async function dockerStatus(cwd) {
...
async function worktreeStatus(repoRoot) {
